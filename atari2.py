...
parser.add_argument('--replay-memory-size', type=int, default=1e3,
                    help='number of samples stored in the replay memory')
parser.add_argument('--target-network-update-freq', type=int, default=10e2,
                    help='frequency (number of DQN updates) with which the '
                         'target DQN is updated')
parser.add_argument('--avg-val-computation-freq', type=int, default=50e2,
                    help='frequency (number of DQN updates) with which the '
...
parser.add_argument('--min-epsilon', type=float, default=0.9,
